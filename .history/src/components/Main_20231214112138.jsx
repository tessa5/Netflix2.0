...
const Main = () => {
  ...
  return (
    <div className='text-white w-full h-[550px]'>
        ...
        <div className= 'absolute top-[30%] w-full w-full md:max-w-[70%] lg:max-w-[35%] p-4 md:p-8'>
            ...
            <p className='w-full md:max-w-[70%] lg:max-w-[35%] text-gray-200'>{truncateString(movie?.overview,120)}</p>
        </div>
    </div>
  )
}
