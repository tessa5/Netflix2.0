...
import { MdChevronLeft, FaChevronRight } from 'react-icons/fa'
...
const Scrollrow = ({title, fetchURL}) => {
  ...
  return (
    <>
        ...
        <MdChevronLeft
            onClick={slideLeft}
            className='bg-white text-green-600 left-0 rounded-full absolute opacity-70 hover:opacity-100 cursor-pointer z-50  group-hover:block'
            size={40}
            />
            <div 
                id={'slider' }
